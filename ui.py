class Flight:
    def __init__(self, airline_id, airline_name, from_location, to_location, departure_time, arrival_time, flight_duration, total_seats):
    ...
    while True:
        ...
        try: 
            ...
            if choice_initial == 1:
                while True:
                    print("""\nPick an option:
                            1. View all outbound flights for a selected destination
                            2. View all outbound flights for a selected date
                            3. View all outbound flights for a selected destination and date
                            4. Exit""")
                    ...
                    try: 
                        ...
                        if choice_view == 1:
                            destination_to_view = input("Please enter your destination\n")
                        
                        elif choice_view == 2:
                            date_to_view = input("Please enter your departure date as DDMMYYYY\n")
