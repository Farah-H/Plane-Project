class Flight:
    def __init__(self, airline_id, airline_name, from_location, to_location, departure_time, arrival_time,
                 flight_duration, total_seats):
...
test_flight = Flight("1", "British Airways", "London", "Paris", "9am", "10am", 60, 100)
body()
